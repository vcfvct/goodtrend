			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-2">
				...
				<div className="px-2">
					...
					<form onSubmit={handleSubmit} className="space-y-4" id="contact-form">
						...
						<div>
							<label htmlFor="inquiry" className="block text-sm font-medium text-gray-700">Inquiry *</label>
							<textarea
								id="inquiry"
								name="inquiry"
								...
								onChange={handleChange}
								rows="4"
								className={`mt-1 block w-full px-3 py-2 border ${errors.inquiry ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
							></textarea>
							{errors.inquiry && (
						...
						<div>
							<button
								type="submit"
								className="w-full bg-indigo-600 px-4 py-2 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
							>
								Submit
							</button>
						</div>
