...
/**
 * Mobile accordion item: shows parent as a link alongside a toggle
 * button that expands/collapses the list of child links.
 */
            ...
            <li key={child.uuid}>
              <a
                ...
                className={cn(
                  ...
                  isActive(child.url) ? 'text-primary font-semibold' : 'text-gray-600'
                )}
              >
                {child.name}
              </a>
          ...
          <div className="flex justify-between items-center w-full">
            ...
            >
              ...
              {isMobile ? (
                    ...
                    item.children.length > 0 ? (
                      ...
                      <li key={item.uuid} className="w-full">
                        <a
                          href={item.url}
                          className={cn(
                            'block px-4 py-2 text-xl transition-colors hover:underline hover:text-primary',
                            isActive(item.url) ? 'text-primary font-semibold' : ''
                          )}
                        >
                          {item.name}
                ...
                /* ----- DESKTOP: unchanged dropdown behaviour ----- */
